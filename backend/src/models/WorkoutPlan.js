...
const exerciseSchema = new mongoose.Schema(
  {
    ...
    movementPattern: { type: String, default: "", trim: true },
      ...
      type: [
        {
          ...
          reviewedOn: { type: String, default: "", trim: true },
        },
      ],
      default: [],
    },
    prescriptionType: { type: String, enum: ["reps", "duration"], default: "reps" },
    targetUnitLabel: { type: String, default: "Reps", trim: true },
    reviewDate: { type: String, default: "", trim: true },
    videoStatus: { type: String, enum: ["verified", "unavailable"], default: "unavailable" },
    videoSourceName: { type: String, default: "", trim: true },
    videoLastValidated: { type: String, default: "", trim: true },
...
const workoutDaySchema = new mongoose.Schema(
  {
    ...
    workoutLocation: { type: String, default: "Both", trim: true },
